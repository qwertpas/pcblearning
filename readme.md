...
## minrc1
Tiny wheeled robot with 2 stepper motors, 3 microphones, and a buzzer. ESP32S3 supermini dev board allows for wireless control, USB-C battery charging, and running small neural networks. Microphones and buzzer may be useful for locating other robots, echolocation, and detecting surface properties (through vibration/noise from ground contact).
![minrc1](minrc1/media/turtleside.jpg)